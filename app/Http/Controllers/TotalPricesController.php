...
class TotalPricesController extends Controller
{
    ...
    public function __invoke(Request $request) : View
    {
        $data = session('data');
        $chart = session('chart');
        //$companies = DatahubPriceList::select('ChargeOwner', 'Note')->get();
        $results = DB::select( DB::raw("SELECT GLN_Number, concat(concat(ChargeOwner, ' '), Note) as tariff, Note, ChargeOwner
