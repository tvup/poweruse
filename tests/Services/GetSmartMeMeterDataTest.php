...
class GetSmartMeMeterDataTest extends TestCase
{
    ...
    public const COUNTER_READING_20220901_0100 = 100042;

    public const COUNTER_READING_20220901_0200 = 100084;

    public const COUNTER_READING_20220901_0300 = 100118;

    public const COUNTER_READING_20220901_0400 = 100118;
    ...
    protected function setUp(): void
    {
        parent::setUp();
        Http::fake([
            'smart-me.com/api/MeterValues/' . self::SMART_ME_ID . '?date=' . urlencode('2022-09-01T01:00:00Z') => Http::response(['CounterReading' => self::COUNTER_READING_20220901_0100], 200),
            'smart-me.com/api/MeterValues/' . self::SMART_ME_ID . '?date=' . urlencode('2022-09-01T02:00:00Z') => Http::response(['CounterReading' => self::COUNTER_READING_20220901_0200], 200),
            'smart-me.com/api/MeterValues/' . self::SMART_ME_ID . '?date=' . urlencode('2022-09-01T03:00:00Z') => Http::response(['CounterReading' => self::COUNTER_READING_20220901_0300], 200),
            'smart-me.com/api/MeterValues/' . self::SMART_ME_ID . '?date=' . urlencode('2022-09-01T04:00:00Z') => Http::response(['CounterReading' => self::COUNTER_READING_20220901_0400], 200),
