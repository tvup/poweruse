                ...
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        <div class="row mt-2">
                            ...
                            <div class="col-md-12 labels mt-2"><label class="labels">{{ __('Refresh token') }}</label><input type="password" class="form-control" name="refresh_token" value="{{ old('refresh_token', Illuminate\Support\Str::repeat('*', Illuminate\Support\Str::length(rescue(fn () => $user->refresh_token, '', false) ?: ''))) }}"></div>
                                <div class="col-md-12">
